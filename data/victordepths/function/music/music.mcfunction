...
execute if predicate victordepths:in_great_aquifer run playsound victordepths:great_aquifer music @s ~ ~ ~ 100
execute if predicate victordepths:in_open run playsound victordepths:open music @s ~ ~ ~ 100
execute if predicate victordepths:in_sanctuary run playsound victordepths:uncharted music @s ~ ~ ~ 100
execute if predicate victordepths:in_underworld run playsound victordepths:underworld music @s ~ ~ ~ 100
execute if predicate victordepths:in_victordepths run playsound victordepths:victordepths music @s ~ ~ ~ 100
execute if predicate victordepths:in_weatherkeep run playsound victordepths:weatherkeep music @s ~ ~ ~ 100