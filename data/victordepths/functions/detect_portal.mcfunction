execute unless predicate victordepths:on_awecloud_portal unless predicate victordepths:on_victordepths_portal if block ~ ~ ~ #minecraft:fire run summon leash_knot ~ ~ ~ {Tags:["vcd_center"]}
