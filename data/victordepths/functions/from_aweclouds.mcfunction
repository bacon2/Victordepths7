...
#execute in minecraft:overworld positioned ~ ~-64 ~ if loaded ~ ~ ~ if entity @e[tag=vcd_base, tag=aweclouds_portal, distance=..33, predicate=victordepths:in_overworld] run say close option
