...
execute in minecraft:overworld positioned over world_surface if loaded ~ ~ ~ if entity @e[tag=vcd_base, tag=forebodium_portal, distance=..33, predicate=victordepths:in_overworld] run scoreboard players set @s vcd_portal_ready 1
