...
#execute in minecraft:overworld positioned ~ ~ ~ if loaded ~ ~ ~ if entity @e[tag=vcd_base, tag=weatherkeep_portal, distance=..33, predicate=victordepths:in_overworld] run say close option
