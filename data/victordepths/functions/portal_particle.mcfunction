...
execute at @s[tag=sanctuary_portal] run particle minecraft:block{block_state:gold_block} ~ ~0.2 ~ 0.25 0.25 0.25 0 1 normal
...
execute at @s[tag=underworld_portal] run particle minecraft:dust{color:[0,0,0],scale:3} ~ ~ ~ 0.3 0.3 0.3 1 1
...
execute at @s[tag=uncharted_portal] run particle minecraft:dust{color:[1,1,0], scale:3} ~ ~0.3 ~ 0.2 0.2 0.2 0 3
