...
execute as @s[tag=fun, nbt=!{Inventory:[{Slot:103b, tag:{nbt:fun_flower}}]}] run item replace entity @s armor.head with minecraft:allium[enchantments={levels:{'minecraft:binding_curse':1,'minecraft:vanishing_curse':1}}, custom_name='{"text":"Fun Flower","italic":false,"color":"#f54ce7"}', minecraft:custom_data={nbt:fun_flower}]
