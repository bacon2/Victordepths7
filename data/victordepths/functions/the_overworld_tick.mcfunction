...
execute as @e[type=item, predicate=victordepths:itemidminecraftnether_star] unless data entity @s {Fire:-1s} at @s run function victordepths:attempt_portal_here
