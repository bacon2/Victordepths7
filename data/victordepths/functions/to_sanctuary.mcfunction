...
execute in victordepths:the_sanctuary positioned ~ 63 ~ if loaded ~ 63 ~ if entity @e[tag=vcd_base, distance=..33, predicate=victordepths:in_sanctuary] run scoreboard players set @s vcd_portal_ready 1
